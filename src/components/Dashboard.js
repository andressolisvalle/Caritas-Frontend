              ...
              <div className="flex items-center">
                ...
                <div className="hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">            
                    ...
                    <Link to='/instituciones' className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                        Instituciones
                    </Link>
                    <Link to='/beneficiarios' className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                        Beneficiarios
                    </Link>
                  </div>
                </div>
          ...
          <div className="md:hidden" id="mobile-menu">
            ...
            <div className="border-t border-gray-700 pb-3 pt-4">
              <div className="flex items-center px-5">
                <div className="flex-shrink-0">
                  {/* <img className="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1605106702841-0e6fc5513f13?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.1&w=256&h=256&q=80" alt=""> */}
                </div>
                <div className="ml-3">
